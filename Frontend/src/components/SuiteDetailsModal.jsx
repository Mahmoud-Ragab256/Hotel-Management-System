      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(10, 17, 40, 0.95), rgba(10, 17, 40, 0.4), transparent)",
            }}
          />
        ...
        >
          <div>
            ...
            <div className="row g-2 text-center border-bottom pb-4 mb-4">
              <div className="col-4 d-flex flex-column gap-1">
                ...
                >
                  {suite.guests} Adults{" "}
                  {suite.children > 0 && `, ${suite.children} C`}
                </span>
              </div>
            ...
            <div className="mb-4 d-flex flex-column gap-2">
              ...
              <div className="row g-2">
                {suite.features.map((feature, index) => (
                  ...
                  >
                    <Check
                      className="w-3.5 h-3.5 text-gold-500 flex-shrink-0"
                      style={{ marginTop: "2px" }}
                    />
                    <span>{feature}</span>
                  </div>
            ...
            <div className="p-3 bg-gold-50 border border-gold-100 rounded-2xl d-flex align-items-start gap-2 text-gold-800 small mb-4">
              ...
              <span style={{ fontSize: "11px", lineHeight: "1.4" }}>
                Complimentary high-speed Wi-Fi, daily turndown services, butler
                coordination, and spa pool credentials are included with your
                suite.
              </span>
            </div>
          </div>
          ...
          <div className="border-top pt-4 d-flex align-items-center justify-content-between gap-3">
            <div>
              ...
              <span className="h4 font-display fw-bold text-dark mb-0">
                ${suite.price}
              </span>
